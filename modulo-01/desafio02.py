...
# Bebidas Não Alcóolicas - BEB
# Bebidas Alcóolicas - BAC

sistema = 'SISTEMA DE CONSULTA DE BEBIDAS'

print('{:=^50}'.format(sistema))
print('')

bebida = input('Informe o código da bebida: ')
print('')
print('Bebidas Não Alcóolicas:', 'BEB' in bebida)
print('Bebidas Alcóolicas:', 'BAC' in bebida)
